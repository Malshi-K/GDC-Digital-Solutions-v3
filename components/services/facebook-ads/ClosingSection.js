          ...
          <div className="flex flex-col md:flex-row md:items-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Get Started with <span className="text-customPurple">GDC Digital Solutions Today!</span>
              </h2>
            ...
            >
              <div className="bg-gray-800/70 rounded-xl p-6 backdrop-blur-sm border border-gray-700 shadow-lg">
                ...
                <a 
                  href="/contact-us" 
                  className="group inline-flex items-center justify-center gap-2 bg-customPurple hover:bg-customLightPurple text-white font-semibold py-3 px-6 rounded-lg w-full transition-all duration-300 transform hover:scale-105"
                >
                ...
                <div className="flex justify-center mt-6">
                  ...
                  <TrackedPhoneLink 
                    ...
                    className="text-sm text-customPurple ml-2 hover:underline"
                  >
                    021 246 3988
                  </TrackedPhoneLink>
                </div>
