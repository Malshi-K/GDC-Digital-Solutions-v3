          ...
          <div className="flex flex-col md:flex-row md:items-center">
            ...
            >
              <div className="bg-gray-800/70 rounded-xl p-6 backdrop-blur-sm border border-gray-700 shadow-lg">
                ...
                <a 
                  href="/contact-us" 
                  className="group inline-flex items-center justify-center gap-2 bg-customYellow hover:bg-customLightYellow text-black font-semibold py-3 px-6 rounded-lg w-full transition-all duration-300 transform hover:scale-105"
                >
                  Contact Us Now
