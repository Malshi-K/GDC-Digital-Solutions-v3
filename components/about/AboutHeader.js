...
export default function AboutHeader() {
  ...
  return (
    <div className="relative bg-white">
      ...
      <div
        className="hidden md:block absolute left-0 top-0 bottom-0 w-14 bg-customPurple"
        aria-hidden="true"
      />

      {/* Decorative right stacked blocks (visible on md+) */}
      <div
        className="hidden md:block absolute right-0 top-8 flex flex-col items-end space-y-4 pr-2"
        aria-hidden="true"
      >
      ...
      <div className="max-w-8xl mx-auto px-6 md:px-8 py-8 md:py-10">
        <div
          className={`fade-in-up ${isLoaded ? "is-visible" : ""} text-center`}
        >
          ...
          <div className="mt-12">
            ...
            <p className="mt-6 text-gray-600 max-w-3xl mx-auto text-sm md:text-base">
              ...
              streamline communication, collaboration, and operational
              efficiency across teams and clients. Today, GDC Digital combines
              technical expertise with proprietary technology to deliver
              scalable digital experiences that drive long-term business growth.
            </p>
          </div>
        </div>
      </div>
