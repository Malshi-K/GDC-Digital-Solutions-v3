...
import SoftwareDevelopmentCaseStudy from '@/components/case-studies/software-development/SoftwareDevelopmentCaseStudy';
...
export async function generateMetadata({ params }) {
  ...
  const siteUrl = 'https://gdcdigital.co.nz';
...
// Main Component
export default function SoftwareDevelopmentCaseStudyPage({ params }) {
  const { slug } = params;
  const caseStudy = getCaseStudyById(slug);
  ...
  return (
    <main>
      <SoftwareDevelopmentCaseStudy caseStudyId={slug} />
    </main>
  );
}